        ...
        <Disclosure.Button className="shadow-sm shadow-gray-400 rounded-xl p-8 w-full">
          <div className="flex justify-between">
            ...
            <div className="flex justify-around w-96 items-start">
              ...
              <div>
                <p>
                  10:45<span className="text-sm">(+1h)</span>
                </p>
            ...
            <div className="w-fit">
              <h1 className="font-bold text-lg">
                Rp. 2.500.000 / <span className="text-sm font-normal">org</span>
              </h1>
              <ButtonPrimary
                title="Beli Sekarang"
                click={() => navigate("/")}
          ...
          <div className="mx-auto w-full rounded-2xl bg-white">
            <Disclosure.Panel className="flex pt-4 h-48 text-left">
              ...
              <div className="flex flex-col justify-between ml-6 h-48">
                <p>
                  Jakarta <br />
                  <span>Bandara Internasional Soekarno Hatta (CGK)</span>
                </p>
                <p className="p-4 bg-slate-100 rounded-md">
                  Indonesia BinarAir, QZ 7518
                </p>
                <p>
                  Bali <br />
                  <span>Bandara Internasional Denpasar Ngurah Rai (DPS)</span>
                </p>
              </div>
            </Disclosure.Panel>
          </div>
