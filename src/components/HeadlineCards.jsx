    ...
    <div>
        <div className='bg-slate-50'>
            ...
            <div className='bg-slate-50 px-10 md:px-20 h-full pb-20 grid grid-cols-2 lg:grid-cols-4 gap-6 justify-center'>
                <div className=''>
                    <img src="https://picsum.photos/id/11/720/400" alt="" className='rounded-xl' />
                    <p className='font-bold mt-2'>Bali Places</p>
                    <span className='text-gray-400'>Lorem, ipsum dolor.</span>
                </div>
                <div className=''>
                    <img src="https://picsum.photos/id/1016/720/400" alt="" className='rounded-xl' />
                    <p className='font-bold mt-2'>Japan Places</p>
                    <span className='text-gray-400'>Lorem, ipsum dolor.</span>
                </div>
                <div className=''>
                    <img src="https://picsum.photos/id/188/720/400" alt="" className='rounded-xl' />
                    <p className='font-bold mt-2'>Hawaii Places</p>
                    <span className='text-gray-400'>Lorem, ipsum dolor.</span>
                </div>
                <div className=''>
                    <img src="https://picsum.photos/id/1016/720/400" alt="" className='rounded-xl' />
                    <p className='font-bold mt-2'>Canada Places</p>
                    <span className='text-gray-400'>Lorem, ipsum dolor.</span>
                </div>             
            </div>
        </div>
