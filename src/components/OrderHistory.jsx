  ...
  return (
    <div className="mx-2 md:mt-[90px] md:ml-5 bg-white shadow-md rounded-md">
      <div className="grid md:grid-cols md:grid-cols-[75%_25%] px-4 my-4 border-b-2">
        ...
        <div className="my-4">
          <button
            className="border-2 px-2 py-2 rounded-full text-gray-600 hover:bg-slate-200 items-center  bg-slate-100 mr-2"
            onClick={() => setSorting("DESC")}
          >
            Recently{" "}
          </button>
          <button
            className="border-2 px-2 py-2 rounded-full text-gray-600 hover:bg-slate-200 items-center bg-slate-100 "
              ...
              <div key={i} className="mx-2 my-2">
                <div className="bg-white w-full border-2 border-gray-100 shadow-md  md:h-[220px] px-14 md:px-4 py-3  rounded-md">
                  ...
                  <div className="md:flex gap-3 items-center text-sm">
                    <p>
                      {histo.bookingType} - {histo.adult} adults, {histo.child}{" "}
                      child
                    </p>
