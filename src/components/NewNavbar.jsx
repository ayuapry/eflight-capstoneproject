...
const navigation = [
    { name: 'Booking Now', href: '#Booking', current: true },
            ...
            <div className="relative flex h-20 items-center justify-between bg-transparent ">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                ...
                {/* <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-sky-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                  ...
                  {open ? (
                    <XMarkIcon color='black' className="block h-6 w-6" aria-hidden="true" />
                  ) : (
                    
                    <Bars3Icon color='black' className="block h-6 w-6" aria-hidden="true" />
                  )}
                </Disclosure.Button> */}
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  {/* <p className='font-bold text-xl mt-5 text-blue-600'>BinarAir</p> */}
                  <img
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-blue-500 hover:text-white',
